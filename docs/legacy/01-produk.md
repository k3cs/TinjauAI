...
Versi 1.1 · 11 Sep 2026 · Hackathon: BUIDL CTC 2026 Fall (track AI) · Status: kontrak v2 dideploy dan terverifikasi di CC3 Testnet, UI live; frontend sedang difinalkan, video menyusul. Panduan pengembangan (sumber kebenaran untuk agent): `docs/00-panduan-pengembangan.md`.

## 0. Posisi (framing sejak 11 Sep)

Tinjau adalah **biro kredit untuk agent AI**. Creditcoin lahir sebagai riwayat kredit untuk peminjam yang tidak terlihat bank (Credal: 5 jt+ transaksi pinjaman, 337 rb pengguna). Agent AI adalah peminjam berikutnya tanpa riwayat yang bisa dicek kontrak. Tinjau mencatat fakta yang dibuktikan (peran biro); ia tidak menilai dan tidak meminjamkan (bukan peran pemberi pinjaman). Premi eskrow sewa = biaya kredit agent.
