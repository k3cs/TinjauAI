...
- Creditcoin began as a credit history for people banks cannot see (Credal: 5M+ loan transactions, 337k users, per creditcoin.org)
...
- Agent **22771**: 3 senior reviewers → premium 1% (100 bps), hire succeeds
- Agent **50283**: 1 reviewer who owns agents (6 proven on-chain), 5 clone siblings proven → quote 16.8% (1,683 bps), hire reverts `Gated(1)` (a review is missing)
